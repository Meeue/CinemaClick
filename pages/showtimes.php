...
<div class="table-wrap"><table>
  <thead><tr><th>ID</th><th>Movie</th><th>Cinema</th><th>Screen</th><th>Date</th><th>Start</th><th>End</th><th>Price</th><th style="text-align:right">Actions</th></tr></thead>
  <tbody>
  ...
  <tr>
    ...
    <td style="text-align:right"><div class="actions">
      ...
      <button class="btn btn-danger btn-sm" onclick="doDelete('<?= e($r['showtime_id']) ?>','<?= e(addslashes($r['title'])) ?> on <?= e($r['show_date']) ?>')">Del</button>
    </div></td>
  </tr>
